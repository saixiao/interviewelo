"""Drop design round: design_sessions, design_prompts

The System Design practice mode (free-text + Claude follow-ups + LLM
grading) has been removed entirely in favor of modes with instant,
non-LLM feedback.
...
def upgrade() -> None:
    ...
    op.drop_index("ix_design_sessions_user_id", table_name="design_sessions")
